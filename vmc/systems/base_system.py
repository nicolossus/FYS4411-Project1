...
class System:
    ...
    def _local_kinetic_energy(self, r, alpha):
        """Inspired by and almost identical to the implementation in
        FermiNet (https://github.com/deepmind/ferminet/blob/02a601268d5dc48cb3cd7846311f25ccc43087e8/ferminet/hamiltonian.py#L62)
