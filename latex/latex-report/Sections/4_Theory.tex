...
where $\bm{r} \in \R^{N\times d}$. In spherical coordinates, the gradient of particle $i$ is given by 


% Vet ikke helt om dette stemmer. Mangler vi ikke to dimensjoner, eller må spesifisere symmetri? 
