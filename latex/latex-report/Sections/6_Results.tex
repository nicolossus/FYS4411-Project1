...
Figure: trace plot that shows convergence of different initial alpha for both RWM and LMH

Figure: Compare which converges the fastest 

Figure: Runtime RWM and LMH 

Figure: Runtime Analytical vs JAX

%----------------------------------------------------------------
\subsection{Variational Energy}
%----------------------------------------------------------------

Figure : LMH Sherical non-interacting / interacting 

Figure: LMH Elliptical non-interacting / interacting  
